...
void kesme ()
{
   set_timer0(217);  // TMR0 kaydedicisine 217 deðeri yükleniyor
   ...
   if (zaman>17350) // Yaklaþýk 115us*17350 = 1,995,250us yaklaþýk 2msn
   {
...
void main ()
{
   ...
   setup_timer_0(RTCC_INTERNAL | RTCC_DIV_2); // Timer0 ayarlarý belirtiliyor
   set_timer0(217);  // TMR0 kaydedicisine 217 deðeri yükleniyor
